...
angular.module('hawtio-ui-test-templates', []).run(['$templateCache', function($templateCache) {$templateCache.put('test-plugins/docs/welcome/welcome.html','<div class="row" ng-controller="WelcomePageController">\n  <div class="col-md-2">\n  </div>\n  <div class="col-md-8">\n    <div ng-bind-html="readme"></div>\n  </div>\n  <div class="col-md-2">\n  </div>\n</div>\n');
