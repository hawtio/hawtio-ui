...
(function (App) {
    ...
    function configureAboutPage(aboutService) {
        'ngInject';
        aboutService.addProductInfo('Hawtio Core', '4.0.14');
    }
...
(function (Nav) {
    var MainNavController = /** @class */ (function () {
        MainNavController.$inject = ["configManager", "userDetails", "mainNavService", "$rootScope", "$interval"];
        function MainNavController(configManager, userDetails, mainNavService, $rootScope, $interval) {
            'ngInject';
            var _this = this;
