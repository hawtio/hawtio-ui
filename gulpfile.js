...
gulp.task('site', ['build', 'build-example'], function() {
  ...
  gulp.src('README.md')
    .pipe(gulp.dest('site'));
  return gulp.src(['index.html', 'hawtio-nav-example.js', 'test/**', 'css/**', 'images/**', 'img/**', 'node_modules/**/*.js', 'node_modules/**/*.css', 'node_modules/**/*.swf', 'node_modules/**/*.woff','node_modules/**/*.woff2', 'node_modules/**/*.ttf', 'node_modules/**/*.map', 'dist/**'], {base: '.'})
    .pipe(gulp.dest('site'));
